...
остатком от деления. Разница видна ровно тогда, когда дуэль затянулась: на сиде
1337 бот дожимал первого больше двух минут, и при отсчёте по сетке передышки не
осталось бы вовсе. Отсчёт от момента смерти даёт одинаковый перерыв независимо
от того, сколько шла дуэль.
...
сделал: +80% за каждого предыдущего.
...
42        467s     died    1433      12        0
1337      720s    alive    1961      15        0
99        380s     died     671      10        0
7         720s    alive    7185      26        1
11        355s     died    1004      10        0
2024      319s     died     390       8        0
5         720s    alive    8686      26        1
808       720s    alive    7303      27        1

дошли до босса: 4/8   свалили хотя бы одного: 3/8   средний забег: 550s
```
...
окна. Сид 1337 всё это время был жив, а в таблице стоял мёртвым.
