...
export const RU: Record<StringId, string> = {
  ...
  'mode.soloHint': 'Один игрок против орды.',
  ...
  'link.connecting': 'Соединяемся с командой…',
  'link.dropped': 'Связь с {who} оборвалась.',
  'link.noSignalling': '{who} так и не ответил. Он ещё в комнате?',
  'link.blocked': 'Эта сеть не выпускает игру наружу. Рабочая или университетская обычно и не выпустит.',
  'link.unreachable': 'Прямого пути к {who} нет. Мобильные сети обычно так не умеют.',
  'link.swapHost': 'Пусть команду создаст тот, у кого проводной интернет.',
  'link.tryAgain': 'Попробуйте другую сеть или раздачу с телефона.',
  'room.begin': 'Начать забег',
  ...
  'room.reach':
    'Код добивает до любого игрока на любой машине. Некоторые сети не пропускают двоих друг к другу.',
