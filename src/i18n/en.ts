...
export const EN = {
  ...
  'party.title': 'Multiplayer',
  'party.sub': 'Somebody makes a team, everybody else joins it.',
  'party.create': 'Create a team',
  'party.createHint': 'You are given a code. Read it out to whoever is playing with you.',
  'party.join': 'Join by code',
  'party.joinHint': 'The code only comes from somebody already waiting in the team.',

  'join.title': 'Join a team',
  'join.sub': 'Six characters, from somebody already in the room.',
  'join.placeholder': 'code',
  'join.confirm': 'Join',
  'join.searching': 'Knocking…',
  'join.badCode': 'A code is six letters and digits, and never O, I, L, 0, 1 or 5.',
  'join.notFound': 'Nobody is waiting on that code.',
  'join.full': 'That team is already four.',
  'join.closed': 'The team was closed.',

  'room.title': 'Waiting room',
  'room.codeLabel': 'Team code',
  'room.codeHint': 'Everyone in the room can see it. Nobody outside can guess it.',
  'room.copy': 'Copy',
  'room.copied': 'Copied',
  'room.roster': 'In the team',
  'room.you': 'you',
  'room.host': 'host',
  'room.slot': 'Player {n}',
  'room.waiting': 'waiting for a seat to fill',
  'room.chatHint': 'press {keys} to talk to the room',
  'room.chatOpen': 'Chat',
  'room.chatPlaceholder': 'say something',
  'room.chatEmpty': 'Nothing said yet.',
  'room.chatFrom': 'Player {n}',
  'room.chatLate': 'You only hear what is said after you arrive.',
  'link.connecting': 'Connecting to the team…',
  'link.dropped': 'The connection to {who} dropped.',
  'link.noSignalling': '{who} never answered. Are they still in the room?',
  'link.blocked': 'This network will not let the game out. A work or campus network usually will not.',
  'link.unreachable': 'No direct route to {who}. Mobile networks usually cannot do this.',
  'link.swapHost': 'Let somebody on a wired connection create the team instead.',
  'link.tryAgain': 'Try another network, or a phone hotspot.',
  'room.begin': 'Start the run',
  ...
  'account.sub': 'A name is yours the moment you use it. A password is only for keeping it somewhere else.',
  'account.name': 'Name',
  'account.password': 'Password',
  'account.login': 'Log in',
  'account.register': 'Register',
  'account.protect': 'Keep this name with a password',
  'account.holding': 'You hold {name} on this browser only.',
  'account.protected': 'Kept. You can log in as {name} anywhere now.',
  'account.loggedIn': 'Signed in as {name}.',
  'account.signOut': 'Sign out',
  'account.signedOut': 'Signed out. This browser no longer holds a name.',
  'account.noRecovery': 'There is no way to reset it — no email is collected, so a forgotten password is a lost name.',
  'account.working': 'Just a moment…',
  'account.failOffline': 'The board did not answer.',
  'account.failInsecure': 'This page is not on a secure connection, so a password will not be sent from it.',
  'account.failWrong': 'That name and password do not go together.',
  'account.failNameTaken': 'That name is already taken.',
  'account.failNotYours': 'This browser does not hold that name.',
